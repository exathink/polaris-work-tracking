...
def upgrade():
    op.add_column('work_items', sa.Column('is_moved', sa.Boolean(), server_default='FALSE', nullable=True), schema='work_tracking')


def downgrade():
    op.drop_column('work_items', 'is_moved', schema='work_tracking')
